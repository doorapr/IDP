...
const langs = {
  "en": {
    ...
    "word-question-prior-question":"<p>Is the word you said the one you expected to be the end of the sentence?</p>",
    ...
    "yes-button": "Yes",
    "no-button": "No",
    "not-understood":"I didn't understand anything",
  ...
  "de": {
    ...
    "word-question-prior-question":"<p>Ist das Wort, welches Sie gesagt haben, auch das, welches Sie als Satzende erwartet haben?</p>",
    ...
    "yes-button": "Ja",
    "no-button": "Nein",
    "not-understood":"Ich habe nichts verstanden",

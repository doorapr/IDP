...
function createTrial(stimulus, record_data) { //TODO: Name
    return { 
        //TODO: Fixation cross?
        timeline: [
        { // Prior
        ...
        {
            stimulus: 'This is the first stimulus.'
        },
        {
            stimulus: 'This is the second stimulus.'
        }
    ]}
}
...
const timeline = [
    ...
    createTrial(jsPsych.timelineVariable('stimulus')) //TODO: Clarify how clarity levels of words are picked across participants.
]
